...
define("@scom/scom-markdown-editor", ["require", "exports", "@ijstech/components", "@scom/scom-markdown-editor/store.ts", "@scom/scom-markdown-editor/data.json.ts", "@scom/scom-markdown-editor/editor/index.tsx", "@scom/scom-markdown-editor/index.css.ts"], function (require, exports, components_4, store_2, data_json_1, index_1) {
    ...
    const LibPath = `${components_4.application.rootDir}libs/@scom/scom-markdown-editor/`;
    ...
    let ScomMarkdownEditor = class ScomMarkdownEditor extends components_4.Module {
        ...
        get inline() {
            var _a;
            return (_a = this._inline) !== null && _a !== void 0 ? _a : true;
        }
        set inline(value) {
            this._inline = value;
        ...
        onSelectionHandler(event) {
            ...
            this.selectionTimer = setTimeout(() => {
                ...
                if (selection && selection.rangeCount > 0) {
                    ...
                    const startContainer = range.startContainer.closest('i-scom-markdown-editor');
                    const endContainer = range.endContainer.closest('i-scom-markdown-editor');
        ...
        async setData(value) {
            ...
            if (this.mdEditor)
                this.mdEditor.setMarkdown(this._data);
        }
        getTag() {
            return this.tag;
        }
